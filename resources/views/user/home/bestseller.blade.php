...
<body>
    <div class="wrapper">
        @include('user.layout.header', ['trang' => 'Sách bán chạy'])
        <div id="content-page" class="content-page">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 mb-3">
                        <h4 class="card-title mb-0">Sách bán chạy nhất</h4>
                    </div>
                </div>
                <div class="row">
                                ...
                                <div class="iq-card-body p-0">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="mb-1 text-muted font-size-13">
                                                Đã bán: <b>{{ $book->LuotMua ?: 0 }}</b>
                                            </div>
                    ...
                    @empty
                        <div class="col-12 text-center text-muted py-5">Không có sách bán chạy nào.</div>
                    @endforelse
                </div>
